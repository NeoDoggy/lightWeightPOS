...
export const Onboarding = {
    steps: [
        ...
        { target: '#dashboard-charts-id', titleKey: 'tour_dash_4_title', descKey: 'tour_dash_4_desc', position: 'inright' },
        { target: '#dashboard-order-his-id', titleKey: 'tour_dash_5_title', descKey: 'tour_dash_5_desc', position: 'inright' },
        { target: '#dashboard-event-select', titleKey: 'tour_dash_6_title', descKey: 'tour_dash_6_desc', position: 'left' },
